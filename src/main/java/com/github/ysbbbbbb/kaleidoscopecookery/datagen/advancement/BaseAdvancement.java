...
public class BaseAdvancement {
    public static void generate(Consumer<AdvancementHolder> saver) {
        ...
        AdvancementHolder netheriteKnife = makeGoal(ModItems.NETHERITE_KITCHEN_KNIFE, "netherite_knife")
                .parent(ironKnife)
        ...
        // 草帽系列成就
        AdvancementHolder strawHat = makeTask(ModItems.STRAW_HAT, "straw_hat")
                .parent(root)
        ...
        AdvancementHolder flowerStrawHat = makeTask(ModItems.STRAW_HAT_FLOWER, "flower_straw_hat")
                .parent(strawHat)
        ...
        AdvancementHolder caterpillar = makeTask(ModItems.CATERPILLAR, "caterpillar")
                .parent(modSeed)
        ...
        AdvancementHolder dualChili = makeTask(ModItems.RED_CHILI, "dual_chili")
                .parent(modSeed)
        ...
        AdvancementHolder ricePanicle = makeTask(ModItems.RICE_PANICLE, "rice_panicle")
                .parent(ironHoe)
        ...
        AdvancementHolder feedChicken = makeTask(ModItems.CATERPILLAR, "feed_chicken")
                .parent(caterpillar)
        ...
        // 汤锅相关成就
        AdvancementHolder stockpot = makeTask(ModItems.STOCKPOT, "stockpot")
                .parent(stove)
        ...
        AdvancementHolder makeSoup = makeTask(ModItems.STOCKPOT_LID, "make_soup")
                .parent(addBroth)
        ...
        AdvancementHolder apprenticeChef = makeGoal(ModItems.BORSCHT, "apprentice_chef")
                .parent(makeSoup)
        ...
        // 稻草人相关成就
        AdvancementHolder scarecrow = makeTask(ModItems.SCARECROW, "scarecrow")
                .parent(farmerSet)
