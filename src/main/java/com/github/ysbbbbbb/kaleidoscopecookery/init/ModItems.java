...
public final class ModItems {
    ...
    public static DeferredItem<Item> SUSPICIOUS_STEW_RICE_BOWL = ITEMS.register("suspicious_stew_rice_bowl", () -> new BowlFoodOnlyItem(ModFoods.SUSPICIOUS_STEW_RICE_BOWL));
